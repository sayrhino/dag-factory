...
docker-run: docker-build ## Runs local Airflow for testing
	@docker run -d -e AIRFLOW__CORE__DAGS_FOLDER=/usr/local/airflow/dags -v /Users/henrytxz/dev/data/dag_factory:/usr/local/airflow/dags -p 127.0.0.1:8080:8080 --name=dag_factory dag_factory:latest
